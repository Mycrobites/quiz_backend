...
class QuizResponse(models.Model):
    ...
    attempted = models.PositiveIntegerField(default=0, null=True, blank=True)
    not_attempted = models.PositiveIntegerField(default=0, null=True, blank=True)
    correct_question = models.PositiveIntegerField(default=0, null=True, blank=True)
    incorrect_question = models.PositiveIntegerField(default=0, null=True, blank=True)
    ...
    subjectwise_difficulty = models.JSONField(blank=True, default=dict)
