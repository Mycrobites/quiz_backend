	...
	def get(self, request, username, quizid):
		...
		for ques in res_dict:
			...
			if obj.question_type == 'Input Type':
				...
				if res_dict[ques] != "":
					try:
						quesdic["Question" + str(totalquestion)] = {"question":obj.question,"correct_answer": temp[str(obj.answer['1'])],"your_answer":temp[str(res_dict[ques])]}
					except:
						quesdic["Question" + str(totalquestion)] = {"question":obj.question,"correct_answer": "option-" + str(obj.answer['1']),"your_answer": "option-" + str(obj.option[str(res_dict[ques])])}
				else:
					try:
						quesdic["Question" + str(totalquestion)] = {"question":obj.question,"correct_answer":  temp[str(obj.answer['1'])],"your_answer": ""}
					except:
						quesdic["Question" + str(totalquestion)] = {"question":obj.question,"correct_answer": "option-" + str(obj.answer['1']),"your_answer": ""}
				if res_dict[ques] != "":
					attemptedquestion += 1
